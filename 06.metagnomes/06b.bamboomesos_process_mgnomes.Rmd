...
```{r}
setwd("~/Library/CloudStorage/GoogleDrive-nicolagk@hawaii.edu/My Drive/Bamboo_mesos/metagenomes")
...
```{r}
metadat <- read.csv("../Bamboo_mesos/bamboomesos_metadata_plusmgs.csv")
...
## Fungi functions (most complicated)
