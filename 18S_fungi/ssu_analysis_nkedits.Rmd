...
#setwd("C:/Users/Renee/Desktop/Lab/Thesis/Real_Data")

counts.tab <- read.csv("bamboomesos_fungi_counts.csv", row.names=1, check.names=FALSE)

tax.tab <- read.csv("bamboomesos_fungi_taxa.csv", row.names=1, check.names=FALSE)

metadata <- read.csv("bamboomesos_metadata_fungi.csv", row.names=1, check.names=FALSE)
