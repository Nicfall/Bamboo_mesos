...
ps.clean <- readRDS("../01.process_asvs/bamboomesos_ps.lulu.clean.decontam.less.rds")
<<<<<<< HEAD
=======
...
df.div.exp.no20.noahk.rich.se$Food_type <- sub("Larval food","Artificial diet",df.div.exp.no20.noahk.rich.se$Food_type)
df.div.exp.no20.noahk.rich.se$Food_type <- sub("Bamboo","Bamboo leaves",df.div.exp.no20.noahk.rich.se$Food_type)
...
#ggarrange(gg.bars.stocks.rich,gg.bars.exp.rich,widths=c(0.5,1),labels=c("(a)","(b)"))
...
a.lar.pup <- aov(Proportion_pupated~InvSimpson*Food_type.x,data=df.div.lar)
summary(a.lar.pup)

##water
shapiro.test(df.div.wtr$Observed)

a.wtr.pup <- aov(Proportion_pupated~InvSimpson*Food_type.x,data=df.div.wtr)
summary(a.wtr.pup)
...
<<<<<<< HEAD
mod.obs.lar <- lmer(Proportion_pupated ~ Observed+Food_type.x+Observed:Food_type.x+(1|Microbe_treatment.x),data=df.div.wtr)
=======
...
mod.obs.lar.noobs <- lmer(Biomass_day40 ~ Food_type.x+Observed:Food_type.x+(1|Microbe_treatment.x),data=df.div.lar)
anova(mod.obs.lar,mod.obs.lar.noobs) #ns 0.1765

mod.obs.lar.nofoo <- lmer(Biomass_day40 ~ Observed+Observed:Food_type.x+(1|Microbe_treatment.x),data=df.div.lar)
#summary(mod.obs.lar.nofoo)
anova(mod.obs.lar,mod.obs.lar.nofoo) #sig 0.001***

mod.obs.lar.noint <- lmer(Biomass_day40 ~ Observed+Food_type.x+(1|Microbe_treatment.x),data=df.div.lar)
#summary(mod.obs.lar)
anova(mod.obs.lar,mod.obs.lar.noint) #sig 0.01**
